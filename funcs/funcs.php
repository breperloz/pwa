<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->isSMTP();
		$mail->SMTPAuth = true;
		$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; //Modificado
		$mail->Host = 'smtp-mail.outlook.com'; //Modificado
		$mail->Port = 587; //Modificado
		
		$mail->Username = 'breperloz_3000@outlook.com'; //Modificado
		$mail->Password = 'Losjuegosdelhambre123#'; //Modificado
		
		$mail->setFrom('breperloz_3000@outlook.com', 'Sitio Web'); //Modificado
